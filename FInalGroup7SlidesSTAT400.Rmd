...
ggplot(boundary, aes(Method, Prob_Outside_Logical_Range, fill=Scenario)) +
  geom_col(position="dodge") +
  scale_fill_manual(values = c(
    "A" = "#ADD8E6",
    "B" = "#061d95" 
...
| **Greenland** | Adjusted for exposure odds  | Still has  boundary issues  | Small Pe, moderate RR                          |
...
- Avoid reporting CIs <0 or CIs >1
