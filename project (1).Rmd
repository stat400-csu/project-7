...
Overall, we can see that there should not be any adjustment in our model for home and away games. The three different graphs showed not much difference between them. We will have to adjust our model for different positions, as there is a noticeable difference in scoring by positions, with point guards, shooting guards and small forwards scoring a bit more points.

Lastly, we will not need to adjust the model for points per minute, as the mean for all NBA games since 2012 is 9.69 ppm and the mean for all Suns vs. Bucks games since 2012 is 10 ppm. 